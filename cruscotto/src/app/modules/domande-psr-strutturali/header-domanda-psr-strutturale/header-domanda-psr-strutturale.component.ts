...
@Component({
  selector: 'app-header-domanda-psr-strutturale',
  templateUrl: './header-domanda-psr-strutturale.component.html',
  styleUrls: ['./header-domanda-psr-strutturale.component.css']
})
export class HeaderDomandaPsrStrutturaleComponent implements OnInit, OnChanges {
