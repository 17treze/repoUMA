...
public enum Ruoli implements Ruolo {
	...
	APERTURA_FASCICOLO_ENTE(Ruoli.APERTURA_FASCICOLO_ENTE_COD),
	REVOCA_ORDINARIA_MANDATO_ENTE(Ruoli.REVOCA_ORDINARIA_MANDATO_ENTE_COD),
	RICHIESTA_REVOCA_IMMEDIATA_AZIENDA_MANDATO(Ruoli.REVOCA_IMMEDIATA_MANDATO_AZIENDA_COD),
	ACCETTAZIONE_REVOCA_IMMEDIATA_MANDATO(Ruoli.ACCETTAZIONE_REVOCA_IMMEDIATA_MANDATO_COD),
	MODIFICA_SPORTELLO_MANDATO(Ruoli.MODIFICA_SPORTELLO_MANDATO_COD),
	AGGIORNAMENTO_MODALITA_PAGAMENTO_FASCICOLO_ENTE(Ruoli.AGGIORNAMENTO_MODALITA_PAGAMENTO_FASCICOLO_ENTE_COD),
	VISUALIZZAZIONE_MODALITA_PAGAMENTO_FASCICOLO_ENTE(Ruoli.VISUALIZZAZIONE_MODALITA_PAGAMENTO_FASCICOLO_ENTE_COD),
	CRUSCOTTO_REVOCA_IMMEDIATA_MANDATO_RICHIESTE_ENTE(Ruoli.CRUSCOTTO_REVOCA_IMMEDIATA_MANDATO_RICHIESTE_ENTE_COD),
	CRUSCOTTO_REVOCA_IMMEDIATA_MANDATO_RICHIESTE_VALUTATE_TUTTI(Ruoli.CRUSCOTTO_REVOCA_IMMEDIATA_MANDATO_RICHIESTE_VALUTATE_TUTTI_COD),
	DICHIARAZIONI_ASSOCIATIVE_VISUALIZZA_UTENTE(Ruoli.DICHIARAZIONI_ASSOCIATIVE_VISUALIZZA_UTENTE_COD),
	DICHIARAZIONI_ASSOCIATIVE_EDITA_UTENTE(Ruoli.DICHIARAZIONI_ASSOCIATIVE_EDITA_UTENTE_COD),
	VISUALIZZAZIONE_FASCICOLO_SOLA_LETTURA_TUTTI(Ruoli.VISUALIZZAZIONE_FASCICOLO_SOLA_LETTURA_TUTTI_COD);
