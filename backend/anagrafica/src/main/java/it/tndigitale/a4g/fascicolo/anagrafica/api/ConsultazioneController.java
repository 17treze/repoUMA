...
import it.tndigitale.a4g.fascicolo.anagrafica.business.service.fascicolo.ConsultazioneService;
import it.tndigitale.a4g.fascicolo.anagrafica.dto.Fascicolo;

/**
 * Controller per gestione operazioni di consultazione su fascicolo AGS con controllo permessi A4G
 *
 * @author B.Irler
 */
@RestController
...
public class ConsultazioneController {
	...
	public List<Fascicolo> ricercaFascicoli(@RequestParam(value = "params")
	...
	public Fascicolo caricaFascicoloByCuaa(@PathVariable(value = "cuaa")
	...
	@PreAuthorize("@abilitazioniComponent.checkLetturaFascicolo()")
	public Fascicolo caricaFascicolo(@PathVariable(value = "id")
	@ApiParam(value = "Identificativo del fascicolo", required = true)
	...
	//	@GetMapping(ApiUrls.AMBITO_PERSONE + "/{cfPersona}" + ApiUrls.AMBITO_AZIENDE + "/{cuaa}"
	//			+ ApiUrls.FUNZIONE_IS_RAPPRESENTANTE_LEGALE)
	//	public KeyValueStringString getAziendaPersonaRappresentante(@PathVariable(value = "cfPersona")
	//	@ApiParam(value = "Codice Fiscale della persona", required = true)
	//	String cfPersona, @PathVariable(value = "cuaa")
	//	@ApiParam(value = "Cuaa dell'azienda", required = true)
	//	String cuaa) throws Exception {
	...
	public boolean controllaEsistenzaFascicoloValido(@PathVariable(value = "cuaa")
	@ApiParam(value = "Cuaa dell'azienda", required = true)
	String cuaa) throws Exception {
	...
	@PreAuthorize("@abilitazioniComponent.checkLetturaFascicolo()")
	public List<Fascicolo> ricercaFascicoliEnte(@RequestParam(value = "params")
	@ApiParam(value = "Parametri di ricerca", required = true)
	String params) throws Exception {
