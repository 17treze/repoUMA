...
--------------------------------DPDNDR77B03L378L - cambio sportello senza revoca ordinaria
insert into A4GT_PERSONA (ID, ID_VALIDAZIONE,VERSIONE,CODICE_FISCALE) values (5,0,0,'DPDNDR77B03L378L');
...
VALUES (1, 0, 0, 'DPDNDR77B03L378L', 'IN_AGGIORNAMENTO', 'DEPEDRI ANDREA', 5, 0, 'APPAG', 'Utente Modifica', to_date('01-01-2020', 'dd-mm-yyyy'));
...
INSERT INTO A4GT_FASCICOLO (ID, ID_VALIDAZIONE, VERSIONE, CUAA, STATO, DENOMINAZIONE, ID_PERSONA, PERSONA_ID_VALIDAZIONE, ORGANISMO_PAGATORE, UTENTE_MODIFICA, DATA_MODIFICA)
VALUES (2, 0, 0, 'MSTFBA79L10H612L', 'IN_AGGIORNAMENTO', 'MSTFBA79L10H612L', 50, 0, 'APPAG', 'Utente Modifica', to_date('01-01-2020', 'dd-mm-yyyy'));
...
-- revoca ordinaria
INSERT INTO A4GT_DETENZIONE (ID, ID_VALIDAZIONE, VERSIONE, DATA_INIZIO, DATA_FINE,  ID_FASCICOLO) 
VALUES(34, 0, 0, to_date('01/01/2021 22:00:00', 'dd/mm/yyyy HH24:MI:SS'), NULL, 2);

INSERT INTO A4GT_MANDATO (ID, VERSIONE, IDENTIFICATIVO_SPORTELLO, CONTRATTO , DATA_SOTTOSCRIZIONE) 
VALUES(34, 0 , 18, 'AAAA', to_date('01/06/2020 22:00:00', 'dd/mm/yyyy HH24:MI:SS'));
