...
VALUES 
	(9999, 0, 0, 'PDRTTR69M30C794R');
	
INSERT INTO A4GD_TIPOLOGIA
	(ID, VERSIONE, DESCRIZIONE, DATA_INIZIO, DATA_FINE, AMBITO)
VALUES
	(894, 0, 'TRATTRICI AGRICOLE', TIMESTAMP '2021-12-13 00:00:00.000000', NULL, 'MACCHINE');
...
VALUES
	(874, 0, 'TRATTRICE SNODATA', 894 , TIMESTAMP '2021-12-13 00:00:00.000000', NULL, 9999);
...
VALUES
	(990, 0, 0, 9999, 0, 874, 'marca', 'modello', 'matricola', 'telaio', 2021, 'COMODATO', '00', 'targa', null);
...
INSERT INTO A4GT_FASCICOLO
	(ID, ID_VALIDAZIONE, VERSIONE, CUAA) 
VALUES 
	(9998, 0, 0, '01720090111');
	
INSERT INTO A4GT_MACCHINA 
	(ID, VERSIONE, ID_VALIDAZIONE, ID_FASCICOLO, ID_VALIDAZIONE_FASCICOLO, ID_SOTTOTIPO, MARCA, MODELLO, NUMERO_MATRICOLA, NUMERO_TELAIO, ANNO_DI_COSTRUZIONE, TIPO_POSSESSO, DOCUMENTO_POSSESSO, TARGA, DATA_IMMATRICOLAZIONE) 
VALUES
	(980, 0, 0, 9998, 0, 874, NULL, 'modello', 'matricola', 'telaio', 2021, 'PROPRIETA', NULL, NULL, NULL);

INSERT INTO A4GT_MACCHINA_MOTORIZZATA 
	(ID, ID_VALIDAZIONE, VERSIONE, MARCA_MOTORE, TIPO_MOTORE, ALIMENTAZIONE, POTENZA, MATRICOLA) 
VALUES
	(980, 0, 0, 'marca', 'tipo', 'GASOLIO', NULL, 'matricola');


INSERT INTO A4GT_FABBRICATO 
	(ID, VERSIONE, ID_VALIDAZIONE, ID_FASCICOLO, ID_VALIDAZIONE_FASCICOLO, ID_SOTTOTIPO, DENOMINAZIONE, INDIRIZZO, COMUNE, VOLUME, SUPERFICIE, DESCRIZIONE) 
VALUES
	(22, 0, 0, 9998, 0, 874, 'asd', 'qw21', 'qw', 2, 4, NULL);
