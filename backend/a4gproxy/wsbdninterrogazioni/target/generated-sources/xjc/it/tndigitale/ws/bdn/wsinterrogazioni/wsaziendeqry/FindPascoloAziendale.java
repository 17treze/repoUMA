...
@XmlRootElement(name = "findPascolo_Aziendale")
public class FindPascoloAziendale {

    @XmlElement(name = "p_pasaz_id")
    protected String pPasazId;

    /**
     * Recupera il valore della proprietà pPasazId.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà pPasazId.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
