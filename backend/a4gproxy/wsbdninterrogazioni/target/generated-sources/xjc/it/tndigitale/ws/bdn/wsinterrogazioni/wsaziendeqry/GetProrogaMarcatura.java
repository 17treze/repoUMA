...
@XmlRootElement(name = "getProrogaMarcatura")
public class GetProrogaMarcatura {

    @XmlElement(name = "p_all_msm_id")
    protected String pAllMsmId;

    /**
     * Recupera il valore della proprietà pAllMsmId.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà pAllMsmId.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
