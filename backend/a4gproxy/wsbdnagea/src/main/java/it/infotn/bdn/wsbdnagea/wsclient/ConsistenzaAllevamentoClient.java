...
public class ConsistenzaAllevamentoClient extends WebServiceGatewaySupport {
	...
	public static final String soapAction = "http://bdr.izs.it/webservices/Consistenza_Allevamento";
	...
	public ConsistenzaAllevamentoResponse inviaConsistenzaAllevamento(ConsistenzaAllevamento request) {
		...
		return (ConsistenzaAllevamentoResponse) getWebServiceTemplate()
				.marshalSendAndReceive(request, new SecurityHeader(autenticazione));
	}
	
	
	 public ConsistenzaAllevamentoResponse _inviaConsistenzaAllevamento(ConsistenzaAllevamento request) {

			
		 	ConsistenzaAllevamentoResponse response = (ConsistenzaAllevamentoResponse) getWebServiceTemplate()
					.marshalSendAndReceive(request, new WebServiceMessageCallback() {

				        public void doWithMessage(WebServiceMessage message) {
				            try {
				                SoapMessage soapMessage = (SoapMessage) message;
				                soapMessage.setSoapAction(ConsistenzaAllevamentoClient.soapAction);
