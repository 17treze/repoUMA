 ...
 *         &lt;element name="id_metodo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "Update_Richiesta_Calcolo_Consistenza", namespace = "http://bdr.izs.it/webservices")
public class UpdateRichiestaCalcoloConsistenza {

    @XmlElement(name = "p_richiesta_cons_id", namespace = "http://bdr.izs.it/webservices")
    protected String pRichiestaConsId;
    @XmlElement(name = "id_metodo", namespace = "http://bdr.izs.it/webservices")
    ...
    /**
     * Recupera il valore della proprietà idMetodo.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà idMetodo.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIdMetodo(String value) {
        this.idMetodo = value;
    }
    ...
    /**
     * Recupera il valore della proprietà pTipoResponsabilita.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà pTipoResponsabilita.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
