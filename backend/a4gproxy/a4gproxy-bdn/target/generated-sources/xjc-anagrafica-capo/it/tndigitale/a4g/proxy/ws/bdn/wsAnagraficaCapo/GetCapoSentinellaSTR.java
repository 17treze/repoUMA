 ...
 *         &lt;element name="p_ident_nome" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "get_Capo_Sentinella_STR")
public class GetCapoSentinellaSTR {

    @XmlElement(name = "p_codice_elettronico")
    protected String pCodiceElettronico;
    @XmlElement(name = "p_ident_nome")
    protected String pIdentNome;
    ...
    /**
     * Recupera il valore della proprietà pIdentNome.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPIdentNome() {
        return pIdentNome;
    }

    /**
     * Imposta il valore della proprietà pIdentNome.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPIdentNome(String value) {
        this.pIdentNome = value;
    }
