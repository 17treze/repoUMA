...
@XmlRootElement(name = "dsREGISTRI_PASCOLI_G")
public class DsREGISTRIPASCOLIG {

    @XmlElement(name = "REGISTRI_PASCOLI")
    protected List<DsREGISTRIPASCOLIG.REGISTRIPASCOLI> registripascoli;
     ...
     * {@link DsREGISTRIPASCOLIG.REGISTRIPASCOLI }
     * 
     * 
     */
    public List<DsREGISTRIPASCOLIG.REGISTRIPASCOLI> getREGISTRIPASCOLI() {
        if (registripascoli == null) {
            registripascoli = new ArrayList<DsREGISTRIPASCOLIG.REGISTRIPASCOLI>();
        }
