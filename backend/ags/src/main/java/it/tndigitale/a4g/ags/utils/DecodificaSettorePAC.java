...
/**
 * Classi di utility per il mapping il vecchio SETTORE e i nuovi PAC.
 * 
 * @author A.Cuel
 *
 */
@Component
public class DecodificaSettorePAC {

	private Map<String, PACKey> valori = new HashMap<>();

	@PostConstruct
	private void popolaValori() {
		valori.put("PI2014", new PACKey("PAC1420", "DU"));
	}

	public Map<String, PACKey> getValori() {
		return valori;
	}
