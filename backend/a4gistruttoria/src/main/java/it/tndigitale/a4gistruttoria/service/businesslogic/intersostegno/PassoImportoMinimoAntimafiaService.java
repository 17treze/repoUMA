...
@Service
public class PassoImportoMinimoAntimafiaService extends ElaboraPassoIstruttoria {

	@Autowired
	private VerificaImportoMinimoAntimafia verificaImportoAntimafia;
	...
	public OpzioniImportoMinimo elaboraPasso(List<VariabileCalcolo> variabiliInput, 
		...
		importoMinimoVariabiliInput.add(new VariabileCalcolo(TipoVariabile.IMPMINIMOLIQ, verificaImportoAntimafia.getSoglia()));
		CodiceEsito esito = verificaImportoAntimafia.apply(dati);
		EsitoControllo controllo = verificaImportoAntimafia.trasformaEsitoInRisultatoEsito(esito);
	...
	public TipologiaPassoTransizione getPasso() {
		return TipologiaPassoTransizione.CONTROLLO_IMPORTO_ANTIMAFIA;
	}
