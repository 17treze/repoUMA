...
public class CambioStatoNonAmmissibileIstruttoriaValidator implements CambioStatoIstruttoriaValidator {
    ...
    public void valida(IstruttoriaModel istruttoria) throws ElaborazioneIstruttoriaException {
        ...
        if (PAGAMENTO_AUTORIZZATO.equals(statoPresente)) {
            throw new ElaborazioneIstruttoriaException("cambiamento di stato in Non Ammissibile fallito. " +
