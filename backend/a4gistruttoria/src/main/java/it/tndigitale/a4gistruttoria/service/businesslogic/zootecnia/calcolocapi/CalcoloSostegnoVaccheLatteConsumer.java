...
@Component
public class CalcoloSostegnoVaccheLatteConsumer extends CalcoloSostegnoVaccheAbstract implements Consumer<RichiestaAllevamDu> {

	private static Logger log = LoggerFactory.getLogger(CalcoloSostegnoVaccheLatteConsumer.class);

	@Autowired
	private ControlloCapoVaccaLatte controlloCapoVaccaLatte;
	@Autowired
	...
	public BiFunction<RichiestaAllevamDu, CapoDto, EsitoCalcoloCapoModel> getComponentControlli() {
		return controlloCapoVaccaLatte;
	}
