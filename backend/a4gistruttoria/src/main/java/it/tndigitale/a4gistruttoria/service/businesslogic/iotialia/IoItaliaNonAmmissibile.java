...
@Component(IoItaliaNonAmmissibile.NOME_QUALIFICATORE)
public class IoItaliaNonAmmissibile extends IoItaliaMessaggioByStato {
	private static final String PROP_MESS_PREFIX="non-ammissibile";
	public static final String NOME_QUALIFICATORE = PREFISSO_NOME_QUALIFICATORE + "NON_AMMISSIBILE";
