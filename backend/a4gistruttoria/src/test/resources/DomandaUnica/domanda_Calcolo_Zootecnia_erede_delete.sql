...
where id_transiz_sostegno in (SELECT ts.id FROM A4GT_TRANSIZIONE_ISTRUTTORIA ts, A4GT_DOMANDA d where ts.id_istruttoria = 56456456478)
);
...
delete from a4gt_dati_erede where id_domanda in (SELECT ID FROM A4GT_DOMANDA WHERE NUMERO_DOMANDA = 181666);
