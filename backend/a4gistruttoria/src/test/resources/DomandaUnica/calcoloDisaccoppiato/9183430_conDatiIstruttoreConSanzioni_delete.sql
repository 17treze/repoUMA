...
DELETE FROM A4GT_ISTRUTTORE_DISACCOPPIATO where ID_ISTRUTTORIA in (SELECT id FROM A4GT_ISTRUTTORIA where id_domanda = (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'BRGNGL64C30C7941'));
