...
INSERT INTO A4GT_PASSO_TRANSIZIONE VALUES (nxtnbr.nextval, 0, (SELECT ts.id FROM A4GT_TRANSIZIONE_ISTRUTTORIA ts where ts.ID_STATO_FINALE=(select id from a4gd_stato_lav_sostegno where identificativo = 'CONTROLLI_INTERSOSTEGNO_OK') and ts.id_istruttoria = 56456456478), 'DISCIPLINA_FINANZIARIA', 'OK', 'DUT_001', '{}', '{"variabiliCalcolo":[{"tipoVariabile":"DFIMPLIQACZ","valNumber":3.6100},{"tipoVariabile":"DFFRPAGACZ_310","valNumber":352.55},{"tipoVariabile":"ACZCAPIACC_310","valNumber":3.6100},{"tipoVariabile":"GREIMPRIC","valNumber":176.28},{"tipoVariabile":"TITVAL","valNumber":99.65},{"tipoVariabile":"TITVALRID","valNumber":97.66}]}', '{}');
INSERT INTO A4GT_PASSO_TRANSIZIONE VALUES (nxtnbr.nextval, 0, (SELECT ts.id FROM A4GT_TRANSIZIONE_ISTRUTTORIA ts where ts.ID_STATO_FINALE=(select id from a4gd_stato_lav_sostegno where identificativo = 'CONTROLLI_CALCOLO_OK') and ts.id_istruttoria = 56456456478), 'CALCOLO_ACZ', 'OK', 'DUT_001', '{}', '{"variabiliCalcolo":[{"tipoVariabile":"DFIMPLIQACZ","valNumber":3.6100},{"tipoVariabile":"DFFRPAGACZ_310","valNumber":352.55},{"tipoVariabile":"ACZCAPIACC_310","valNumber":3.6100},{"tipoVariabile":"GREIMPRIC","valNumber":176.28},{"tipoVariabile":"TITVAL","valNumber":99.65},{"tipoVariabile":"ACZCAPIACC_310","valNumber":97.66}]}', '{}');
INSERT INTO A4GT_PASSO_TRANSIZIONE VALUES (nxtnbr.nextval, 0, (SELECT ts.id FROM A4GT_TRANSIZIONE_ISTRUTTORIA ts where ts.ID_STATO_FINALE=(select id from a4gd_stato_lav_sostegno where identificativo = 'LIQUIDABILE') and ts.id_istruttoria = 56456456478), 'LIQUIDABILITA', 'OK', 'DUT_001', '{}', '{"variabiliCalcolo":[{"tipoVariabile":"DFIMPLIQACZ","valNumber":3.6100},{"tipoVariabile":"DFFRPAGACZ_310","valNumber":352.55},{"tipoVariabile":"ACZCAPIACC_310","valNumber":3.6100},{"tipoVariabile":"GREIMPRIC","valNumber":176.28},{"tipoVariabile":"TITVAL","valNumber":99.65},{"tipoVariabile":"ACZCAPIACC_310","valNumber":97.66}]}', '{"variabiliCalcolo":[],"esitiControlli":[{"tipoControllo":"BRIDUNVL129_erede","esito":true,"livelloControllo":"INFO"}],"variabiliParticellaColtura":null,"variabiliCalcoloDaStampare":[]}');

INSERT INTO A4GT_DATI_EREDE
(ID, VERSIONE, ID_DOMANDA, CERTIFICATO, COGNOME, NOME, CODICE_FISCALE, IBAN, INDIRIZZO, CODICE_ISTAT, PROVINCIA, CAP, SESSO, COD_ISTAT_NASCITA, PROVINCIA_NASCITA)
VALUES(NXTNBR.nextval, 0 , SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'BRTSRG86A24L174X', 1, 'co', 'bru', 'cf', 'IT60X0542811101000000123456', 'via pippo', '12345', 'na', '8001', 'M', 'pippo' , 'na');
