...
values (999111, 0,
		(SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'BNDCLD69S12C999Z' AND NUMERO_DOMANDA = 180999),
		true,
		'Rossi',
		'Mario',
		'RSSMRA70A13F839C',
		...
		'via mario rossi 2',
		'00001', 'NA', '12345',
		to_date('01/04/2019 02:00:00','dd/mm/yyyy hh24:mi:ss'));
...
values (999112, 0, 999112,
		...
		'{
			"variabiliCalcolo": [],
			"esitiControlli": [{
					"tipoControllo": "BRIDUNVL129_erede",
					"esito": true,
