--- Domanda acs MARCABRUNI ANTONIO DOMANDA 189699
Insert into A4GT_DOMANDA
 ...
 Values
   (NXTNBR.NEXTVAL, 3, 189699, 'BPS_2018', 'PAGAMENTI DIRETTI', 
    2018, 'IN_ISTRUTTORIA', 'MRCNTN53A16A3720', TO_DATE('06/08/2018 15:55:19', 'MM/DD/YYYY HH24:MI:SS'), 7, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE NUMERO_DOMANDA = 189699), 431, 431, 
...
values(NXTNBR.nextval,0,(SELECT ID FROM A4GT_DOMANDA WHERE NUMERO_DOMANDA = 189699),'SUPERFICIE',(select id from a4gd_stato_lav_sostegno where identificativo = 'RICHIESTO'), 'SALDO');

INSERT INTO A4GT_ISTRUTTORE_SUPERFICIE (ID, CONTROLLO_SIGECO_LOCO, SUP_OLIVOPENDENZA_M16, VERSIONE, ID_ISTRUTTORIA) VALUES (NXTNBR.nextval, 1, 0.5706, 0, NXTNBR.CURRVAL-1);

INSERT INTO A4GD_REG_OLIO_NAZIONALE (ID, VERSIONE, CUAA_INTESTATARIO, INIZIO_CAMPAGNA, FINE_CAMPAGNA) VALUES (NXTNBR.NEXTVAL, 0, 'MRCNTN53A16A3720', 2016, 2020);
INSERT INTO A4GD_REG_OLIO_QUALITA (ID, VERSIONE, CUAA_INTESTATARIO, INIZIO_CAMPAGNA, FINE_CAMPAGNA) VALUES (NXTNBR.NEXTVAL, 0, 'MRCNTN53A16A3720', 2016, 2020);
