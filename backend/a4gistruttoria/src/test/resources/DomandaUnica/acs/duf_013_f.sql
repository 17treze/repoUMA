--- Domanda acs MASO PRAEL DI SIGNORETTI NATALINO DOMANDA 189677
Insert into A4GT_DOMANDA
 ...
 Values
   (NXTNBR.NEXTVAL, 3, 189677, 'BPS_2018', 'PAGAMENTI DIRETTI', 
    2018, 'IN_ISTRUTTORIA', 'SGNNLN54T28A372W', TO_DATE('06/08/2018 15:55:19', 'MM/DD/YYYY HH24:MI:SS'), 7, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'), 26, 26, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'), 1, 1, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'), 1513, 1513, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'), 3500, 3500, 
...
Insert into A4GT_RICHIESTA_SUPERFICIE
   (ID, VERSIONE, ID_DOMANDA, SUP_RICHIESTA, SUP_RICHIESTA_NETTA, 
    ...
    ID_INTERVENTO)
 Values
   (NXTNBR.NEXTVAL, 0, (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'), 2, 2, 
...
values(NXTNBR.nextval,0,(SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = 'SGNNLN54T28A372W'),'SUPERFICIE',(select id from a4gd_stato_lav_sostegno where identificativo = 'RICHIESTO'), 'SALDO');

INSERT INTO A4GD_REG_OLIO_NAZIONALE (ID, VERSIONE, CUAA_INTESTATARIO, INIZIO_CAMPAGNA, FINE_CAMPAGNA) VALUES (NXTNBR.NEXTVAL, 0, 'SGNNLN54T28A372W', 2016, 2020);
INSERT INTO A4GD_REG_OLIO_QUALITA (ID, VERSIONE, CUAA_INTESTATARIO, INIZIO_CAMPAGNA, FINE_CAMPAGNA) VALUES (NXTNBR.NEXTVAL, 0, 'SGNNLN54T28A372W', 2016, 2020);
