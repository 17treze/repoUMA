delete from A4GT_DOMANDA_INTEGRATIVA where identificativo = 'DI_1140_DUF11';
delete from A4GT_ESITO_CALCOLO_CAPO where ID_ALLEVAM_DU in (select id from A4GT_ALLEVAMENTO_IMPEGNATO where id_domanda = (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = '02228060220'));
delete from A4GT_ALLEVAMENTO_IMPEGNATO where id_domanda = (SELECT ID FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = '02228060220');
...
delete FROM A4GT_DOMANDA WHERE CUAA_INTESTATARIO = '02228060220';
