...
//    		"INSERT INTO A4GT_EVENTSTORED (ID, VERSIONE, EVENTO, JSON_EVENT, NUMERO_RETRY, DATA_INSERIMENTO, ERRORE) VALUES(?, 0, ?, ?, ?, ?, ?)"; // [SPRING.2.2.0.RELEASE] funziona con generatedId forzato a String
            "INSERT INTO A4GT_EVENTSTORED (ID, VERSIONE, EVENTO, JSON_EVENT, USER_NAME, NUMERO_RETRY, DATA_INSERIMENTO, ERRORE) VALUES(NXTNBR.NEXTVAL, ?, ?, ?, ?, ?, ?, ?)";
    private static final String SQL_SELECT_BY_ID =
            "SELECT ID, VERSIONE, EVENTO, JSON_EVENT, USER_NAME, DATA_INSERIMENTO, NUMERO_RETRY, ERRORE FROM A4GT_EVENTSTORED WHERE ID = ?";
    private static final String SQL_DELETE =
            "DELETE FROM A4GT_EVENTSTORED WHERE ID = ?";
    private static final String SQL_SELECT_ALL =
            "SELECT ID, VERSIONE, EVENTO, JSON_EVENT, USER_NAME, DATA_INSERIMENTO, NUMERO_RETRY, ERRORE FROM A4GT_EVENTSTORED";
