...
*/
import ol_ext_inherits from '../../../../node_modules/ol-ext/util/ext'
import {unByKey as ol_Observable_unByKey} from '../../../../node_modules/ol/Observable'
import ol_control_Control from '../../../../node_modules/ol/control/Control'
import ol_layer_Tile from '../../../../node_modules/ol/layer/Tile'
import ol_layer_Vector from '../../../../node_modules/ol/layer/Vector'
import ol_layer_VectorTile from '../../../../node_modules/ol/layer/VectorTile'
// ol < 6 compatibility VectorImage is not defined
// import ol_layer_VectorImage from 'ol/layer/VectorImage'
import ol_layer_Image from '../../../../node_modules/ol/layer/Image'
import ol_layer_Heatmap from '../../../../node_modules/ol/layer/Heatmap'
import {intersects as ol_extent_intersects} from '../../../../node_modules/ol/extent'

import ol_ext_element from '../../../../node_modules/ol-ext/util/element'
...
var ol_control_LayerSwitcher = function(options) {
  ...
  this.hasrefresh = options.refresh;
...
ol_control_LayerSwitcher.prototype.testLayerVisibility = function(layer) {
  ...
  if (layer.getMaxResolution()<=res || layer.getMinResolution()>=res) {
    layer.values_.Ispezionabile = false;
    return false;
    ...
    layer.values_.Ispezionabile = true;
    return true;
  }
};
...
ol_control_LayerSwitcher.prototype.drawList = function(ul, collection) {
  ...
  // Refresh a layer on refresh click
  function refreshLayer(e) {
    e.stopPropagation();
    e.preventDefault();

    let object = self._getLayerForLI(this.parentNode.parentNode);

    if(object.getLayers) {
      let layers = object;

      layers.getLayers().forEach(refreshWmsLayer);
    } else {
      let layer = object;
  ...
  function createLi(layer) {
    ...
    // Refresh button
    if (this.hasrefresh && layer.getSource && layer.getSource().updateParams) {
      ol_ext_element.create('DIV', {
        className: 'layerRefresh',
        title: this.tip.refresh,
        click: refreshLayer,
        parent: layer_buttons
      });
    }
