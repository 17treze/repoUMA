...
export const environment = {
  production: true,
  backendUrl: 'https://a4g.provincia.tn.it/dipendente/',
  frontendUrl: 'https://a4g.provincia.tn.it/dipendente/a4g/',
  srTrentoUrl: 'https://srt.infotn.it/dipendente/homepage.aspx',
