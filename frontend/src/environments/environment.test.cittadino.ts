...
export const environment = {
  production: false,
  backendUrl: 'https://a4g-test.infotn.it/cittadino/',
  frontendUrl: 'https://a4g-test.infotn.it/cittadino/a4g/',
  srTrentoUrl: 'https://srt-test.infotn.it/cittadino/homepage.aspx',
