...
export const environment = {
  production: false,
  backendUrl: 'https://a4g-test.infotn.it/dipendente/',
  frontendUrl: 'https://a4g-test.infotn.it/dipendente/a4g/',
  srTrentoUrl: 'https://srt-test.infotn.it/dipendente/homepage.aspx',
  mobileUrl: 'https://myappag-test.tndigit.it/cittadino/cruscotto/',
  agsUrl: 'http://siap-test.infotn.it',
  tipoLogin: 'dipendente',
