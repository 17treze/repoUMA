...
export const environment = {
  production: true,
  backendUrl: 'https://a4g-qual.infotn.it/dipendente/',
  frontendUrl: 'https://a4g-qual.infotn.it/dipendente/a4g/',
  srTrentoUrl: 'https://srt-qual.infotn.it/dipendente/homepage.aspx',
