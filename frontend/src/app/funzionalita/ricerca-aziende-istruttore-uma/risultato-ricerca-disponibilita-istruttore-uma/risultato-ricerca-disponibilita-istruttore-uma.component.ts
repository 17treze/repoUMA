...
@Component({
  selector: 'app-risultato-ricerca-disponibilita-istruttore-uma',
  templateUrl: './risultato-ricerca-disponibilita-istruttore-uma.component.html',
  styleUrls: ['./risultato-ricerca-disponibilita-istruttore-uma.component.scss']
})
export class RisultatoRicercaDisponibilitaIstruttoreUMAComponent implements OnInit, OnChanges, OnDestroy {
