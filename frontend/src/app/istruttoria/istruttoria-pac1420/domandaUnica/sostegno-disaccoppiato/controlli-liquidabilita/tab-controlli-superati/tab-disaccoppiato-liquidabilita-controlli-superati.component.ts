...
@Component({
  selector: 'app-tab-disaccoppiato-liquidabilita-controlli-superati',
...
export class TabDisaccoppiatoLiquidabilitaControlliSuperatiComponent extends TabDisaccoppiatoCommonComponent implements OnInit, OnDestroy {
