...
@Component({
  selector: 'app-tab-disaccoppiato-liquidabilita-liquidabile',
...
export class TabDisaccoppiatoLiquidabilitaLiquidabileComponent extends TabDisaccoppiatoCommonComponent implements OnInit, OnDestroy {
