...
@Component({
  selector: 'app-container-disaccoppiato',
...
export class ContainerDisaccoppiatoComponent extends ContainerElencoIstruttorieComponent {
  
  constructor(activatedRoute: ActivatedRoute) {
    super(activatedRoute, SostegnoDu.DISACCOPPIATO);
  }
}
