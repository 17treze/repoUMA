...
@Component({
  selector: 'app-tab-disaccoppiato-liquidazione-liquidabile',
...
export class TabDisaccoppiatoLiquidazioneLiquidabileComponent extends TabDisaccoppiatoCommonComponent implements OnInit, OnDestroy {
  constructor(
