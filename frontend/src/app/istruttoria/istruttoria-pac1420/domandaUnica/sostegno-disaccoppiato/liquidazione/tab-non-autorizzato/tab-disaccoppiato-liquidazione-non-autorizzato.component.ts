...
@Component({
  selector: 'app-tab-disaccoppiato-liquidazione-non-autorizzato',
...
export class TabDisaccoppiatoLiquidazioneNonAutorizzatoComponent extends TabDisaccoppiatoCommonComponent {
  constructor(
