...
@Component({
  selector: 'app-tab-Superfici-liquidazione-liquidabile',
...
export class TabSuperficiLiquidazioneLiquidabileComponent extends TabSuperficiCommonComponent implements OnInit, OnDestroy {
  constructor(
