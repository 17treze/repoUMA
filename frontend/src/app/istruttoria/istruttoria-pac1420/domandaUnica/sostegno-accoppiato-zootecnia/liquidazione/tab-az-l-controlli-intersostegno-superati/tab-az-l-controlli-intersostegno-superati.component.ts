...
@Component({
  selector: 'app-tab-az-l-controlli-intersostegno-superati',
...
export class TabAzLControlliIntersostegnoSuperatiComponent extends TabAzCommonComponent implements OnInit, OnDestroy {
