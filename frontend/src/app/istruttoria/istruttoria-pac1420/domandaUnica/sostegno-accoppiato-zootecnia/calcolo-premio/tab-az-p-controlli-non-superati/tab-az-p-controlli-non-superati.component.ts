...
@Component({
  selector: 'app-tab-az-p-controlli-non-superati',
...
export class TabAzPControlliNonSuperatiComponent extends TabAzCommonComponent implements OnInit, OnDestroy {
  ...
  setStatusNonAmmissibile() {
    console.log("setStatusNonAmmissibile()");
  }
}
