...
export class AnagraficaFascicoloService {
  ...
  private urlRicercaFascicoliAual = `${this.configuration.anagrafe_unica_lazio}/fascicolo-aual/ricerca`;
  ...
  public getAnagraficaFascicolo(filtro: FiltroRicercaFascicoli, paginazione: Paginazione): Observable<PaginatorA4G<FascicoloDTO[]>> {
    ...
    return this.http.get<PaginatorA4G<FascicoloDTO[]>>(`${this.urlRicercaFascicoliAual}`, { params: data, headers: headers });
  }
